...
\input{../LaTeX_Include/Package/Package.tex}
% \import{../LaTeX_Include/Package/}{Package.tex}

%! "\include{}"命令会使编译报错
% \include{../LaTeX_Include/Package/Package.tex}
...
% "\input"命令
%! \input{../LaTeX_Include/Chapter1/Chapter_1.tex}
%! 不要使用上面这条命令，因为引用的文件"Chapter_1.tex"中存在"\input{}"命令
\input{../LaTeX_Include/Chapter2/Chapter_2.tex}
\input{../LaTeX_Include/Forbidden/Forbidden.tex}

% "\include"命令
% "\include"命令会在引用文件前添加"\clearpage"命令进行分页
%! "\include{}"命令会使编译报错
% \include{../LaTeX_Include/Chapter1/Chapter_1.tex}
% \include{../LaTeX_Include/Chapter2/Chapter_2.tex}
% \include{../LaTeX_Include/Forbidden/Forbidden.tex}
