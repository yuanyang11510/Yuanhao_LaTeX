...
\usepackage{amsmath} 
            % 宏包amsmath提供了"\eqref"命令，默认效果如"(3.1)"所示
...
\section{\LaTeX 基础}
    ...
    \subsection{浮动体与图表}
        ...
        \subsubsection{图片}
        % 使用graphicx宏包的"\includegraphics[options]{name}"命令插入图片
            \begin{center}
            ...
            \begin{center}
                \includegraphics[width=0.8\linewidth]{doraemon1.jpg}
            \end{center}
            % 可选参数指定了图片宽度为0.8倍该行文字宽
